...
///
/// See [`NPointXo`](super::n_point_xo::NPointXo) and
...
/// Error generated by uniform crossover operations
///
/// Uniform crossover will fail if the two genomes don't
...
impl<E> Error for UniformCrossoverError<E>
where
    E: Error + 'static,
    Self: Debug + Display,
{
...
impl<E> Display for UniformCrossoverError<E> {
...
impl<E> From<DifferentGenomeLength> for UniformCrossoverError<E> {
    fn from(source: DifferentGenomeLength) -> Self {
        Self::DifferentGenomeLength(source)
    }
}
impl<E> Diagnostic for UniformCrossoverError<E>
where
...
/// Error generated by N-point crossover operators
///
/// N-point crossover will fail if:
///   - The two genomes don't have the same length
///     ([`NPointCrossoverError::DifferentGenomeLength`])
///   - The genome is too short to contain the necessary number of crossover
...
impl<E> Error for NPointCrossoverError<E>
where
    E: Error + 'static,
    Self: Debug + Display,
{
...
impl<E> Display for NPointCrossoverError<E> {
    fn fmt(&self, formatter: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            Self::DifferentGenomeLength(g) => Display::fmt(&g, formatter),
...
impl<E> From<DifferentGenomeLength> for NPointCrossoverError<E> {
    fn from(source: DifferentGenomeLength) -> Self {
        Self::DifferentGenomeLength(source)
    }
}
impl<E> From<GenomeLengthTooShort> for NPointCrossoverError<E> {
    fn from(source: GenomeLengthTooShort) -> Self {
        Self::GenomeLengthTooShort(source)
    }
}
impl<E> Diagnostic for NPointCrossoverError<E>
where
    E: Error + Diagnostic + 'static,
{
    fn code(&self) -> Option<Box<dyn Display + '_>> {
