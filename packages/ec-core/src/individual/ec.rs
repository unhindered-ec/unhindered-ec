...
///
/// let individual_generator = IndividualDistribution::new(genome_generator, scorer);
///
...
pub struct IndividualDistribution<GG, S> {
    pub genome_generator: GG,
    pub scorer: S,
}

impl<GG, S> IndividualDistribution<GG, S> {
...
impl<GG> WithScorer for GG {
    ...
    /// ```
    fn with_scorer<S, G>(self, scorer: S) -> IndividualDistribution<GG, S>
    where
        S: Scorer<G>,
    {
