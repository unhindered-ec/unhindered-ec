...
// The implementation of Default here is somewhat arbitrary and more for
// actually having a value in i.e. a global state if it is required rather than
// for the actual value contained.
