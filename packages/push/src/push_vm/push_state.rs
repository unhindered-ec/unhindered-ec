use super::State;
use crate::instruction::{push::PushInstruction, Instruction};
...
mod simple_check {
    use crate::{
        instruction::push::{BoolInstruction, IntInstruction},
        push_vm::push_state::{Inputs, PushInstruction, PushState},
    };
