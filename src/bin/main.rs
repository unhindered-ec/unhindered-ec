...
mod tests {
    ...
    use rust_ga::individual::count_ones;
    ...
    fn test_individual_new() {
        ...
        assert_eq!(ind.bits.len(), 128);
        assert_eq!(ind.fitness, count_ones(&ind.bits));
    }
    ...
    fn test_population_new() {
        ...
        assert_eq!(pop.individuals[0].bits.len(), 128);
        assert_eq!(pop.individuals[0].fitness, count_ones(&pop.individuals[0].bits));
    }
}
